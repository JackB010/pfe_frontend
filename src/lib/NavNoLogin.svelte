...
{#if done}
    <div class="flex flex-col items-center">
        <div
            class="  absolute py-1 sm:-ml-20 mb-4 z-[10000] w-[25.6rem] h-[16rem] rounded shadow ring-1 ring-black ring-opacity-25 dark:bg-dark focus:outline-none bg-white border-y-4 border-y-rose-600 dark:bg-slate-900 overflow-y-scroll"
            bind:clientHeight="{y}"
            on:scroll="{(e) => {
