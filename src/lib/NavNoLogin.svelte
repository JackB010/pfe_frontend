...
<Wapper>
    ...
    >
        ...
        <div class=" -mt-2 mr-3 ">
            {#if $location === '/'}
                <a href="/signup" use:link><Button>Sign Up</Button></a>
            {:else}
                <a href="/" use:link><Button>Log In</Button></a>{/if}
        </div>
        <div class=" -mt-2 mr-3 ">
            <button
     ...
     dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5"
            >
                {#if $theme === 'dark'}
                    <svg
