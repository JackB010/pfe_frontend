...
<div
    ...
    class="w-full h-10 {error
        ? 'bg-red-400/60'
        : 'bg-green-300/60'} text-center w-[96%] space-x-2 pl-2 rounded shadow mx-auto mb-5 text-lg flex items-center"
>
    <span
        ><svg
    ...
    >
    <span
        >{#if !error}succed{:else}faild{/if}</span
    >
</div>
