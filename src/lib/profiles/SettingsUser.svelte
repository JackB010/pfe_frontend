...
<Wapper>
    {#if !is_delete}
        <div class="m-2 flex flex-col space-y-3" in:fade>
            <div
                class="flex  items-center px-2 text-white rounded-lg bg-rose-600 hover:bg-rose-700 h-9 shadow-lg cursor-pointer"
                on:click="{() => {
                    push(`/profile/${$usershortinfo.username}/settings/change`);
                }}"
                on:keypress="{() => {}}"
            >
            ...
            <div class=" flex items-center">
                ...
                <div class="text-center ">
                    <span
                        class="float-right bg-rose-600  text-white mr-4 mb-2 rounded-lg cursor-pointer shadow-lg w-24 py-2"
                        on:click="{() => {
                            UpdateUser();
                        }}"
